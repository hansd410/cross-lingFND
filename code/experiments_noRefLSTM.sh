...
python train.py --ref False --model lstm
mv save/adan /mnt/hansd410/adanModel/noRefLSTM1

python train.py --ref False --model lstm
mv save/adan /mnt/hansd410/adanModel/noRefLSTM2

python train.py --ref False --model lstm
mv save/adan /mnt/hansd410/adanModel/noRefLSTM3

python train.py --ref False --model lstm
mv save/adan /mnt/hansd410/adanModel/noRefLSTM4

python train.py --ref False --model lstm
mv save/adan /mnt/hansd410/adanModel/noRefLSTM5
