...
python train.py --n_critic 0 --lambd 0
mv save/adan /mnt/hansd410/adanModel/noAdv1

python train.py --n_critic 0 --lambd 0
mv save/adan /mnt/hansd410/adanModel/noAdv2

python train.py --n_critic 0 --lambd 0
mv save/adan /mnt/hansd410/adanModel/noAdv3

python train.py --n_critic 0 --lambd 0
mv save/adan /mnt/hansd410/adanModel/noAdv4

python train.py --n_critic 0 --lambd 0
mv save/adan /mnt/hansd410/adanModel/noAdv5
