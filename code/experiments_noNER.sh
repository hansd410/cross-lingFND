...
python train.py --src_ref_dir ../data/NAIVE/Eng/ --tgt_ref_dir ../data/NAIVE/Kor/ --enRef_X_train en_train_data.txt --enRef_X_test en_test_data.txt --koRef_X_file ko_data.txt
mv save/adan /mnt/hansd410/adanModel/noNERver2

python train.py --src_ref_dir ../data/NAIVE/Eng/ --tgt_ref_dir ../data/NAIVE/Kor/ --enRef_X_train en_train_data.txt --enRef_X_test en_test_data.txt --koRef_X_file ko_data.txt
mv save/adan /mnt/hansd410/adanModel/noNERver3

python train.py --src_ref_dir ../data/NAIVE/Eng/ --tgt_ref_dir ../data/NAIVE/Kor/ --enRef_X_train en_train_data.txt --enRef_X_test en_test_data.txt --koRef_X_file ko_data.txt
mv save/adan /mnt/hansd410/adanModel/noNERver4

python train.py --src_ref_dir ../data/NAIVE/Eng/ --tgt_ref_dir ../data/NAIVE/Kor/ --enRef_X_train en_train_data.txt --enRef_X_test en_test_data.txt --koRef_X_file ko_data.txt
mv save/adan /mnt/hansd410/adanModel/noNERver5
