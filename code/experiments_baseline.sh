...
python train.py --ref False --n_critic 0 --lambd 0
mv save/adan /mnt/hansd410/adanModel/baseline1

python train.py --ref False --n_critic 0 --lambd 0
mv save/adan /mnt/hansd410/adanModel/baseline2

python train.py --ref False --n_critic 0 --lambd 0
mv save/adan /mnt/hansd410/adanModel/baseline3

python train.py --ref False --n_critic 0 --lambd 0
mv save/adan /mnt/hansd410/adanModel/baseline4

python train.py --ref False --n_critic 0 --lambd 0
mv save/adan /mnt/hansd410/adanModel/baseline5
