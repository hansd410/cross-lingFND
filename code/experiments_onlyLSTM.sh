...
mv save/adan /mnt/hansd410/adanModel/onlyLSTM1

python train.py --model lstm
mv save/adan /mnt/hansd410/adanModel/onlyLSTM2

python train.py --model lstm
mv save/adan /mnt/hansd410/adanModel/onlyLSTM3

python train.py --model lstm
mv save/adan /mnt/hansd410/adanModel/onlyLSTM4

python train.py --model lstm
mv save/adan /mnt/hansd410/adanModel/onlyLSTM5
